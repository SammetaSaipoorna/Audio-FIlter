...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11055 - SAMMETA SAI POORNA $^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
$https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/saipoorna.wav
\end{lstlisting}
...
\item
The output of the python script in Problem \ref{prob:output} is the audio file saipoorna_filtered.wav. Play the file in the spectrogram in Problem \ref{prob:spectrogram}. What do you observe?
\\
...
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code1.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code1.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code3.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code6.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code7.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code8.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code9.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{-2.30244827 }y(n - 1) + \brak{ 2.20908011}y(n - 2) \nonumber \\
	&- \brak{-0.99219366}y(n - 3) + \brak{ 0.1742301  }y(n - 4) \nonumber \\
	&= \brak{0.00554177}x(n) + \brak{0.02216707}x(n - 1) \nonumber \\
	&+ \brak{0.03325061}x(n - 2) + \brak{0.02216707}x(n - 3) \nonumber \\
	&+ \brak{0.00554177}x(n - 4)
\end{align}
...
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code10.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/SammetaSaipoorna/Audio-FIlter/tree/main/codes/code11.py
\end{lstlisting}
\begin{figure}[H]
\centering
